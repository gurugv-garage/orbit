...
- [3. node-rover](#3-node-rover)
  - [Hardware BOM](#hardware-bom)
  - [Software stack](#software-stack)
  - [Standalone behavior](#standalone-behavior)
  - [Key limitations](#key-limitations)
- [4. node-dock](#4-node-dock)
  - [Per-dock BOM](#per-dock-bom)
  - [Why phones (not a Pi + USB mic / camera)](#why-phones-not-a-pi--usb-mic--camera)
  - [What runs on the phone](#what-runs-on-the-phone)
  - [Optional servo body — BodyLink](#optional-servo-body--bodylink)
  - [Self-update (OTA)](#self-update-ota)
  - [What runs at plat (central, for any dock)](#what-runs-at-plat-central-for-any-dock)
  - [Topic / channel structure](#topic--channel-structure)
  - [Standalone behavior](#standalone-behavior-1)
  - [Engagement ideas — making the dock feel alive](#engagement-ideas--making-the-dock-feel-alive)
  - [Key risks (from research — read carefully)](#key-risks-from-research--read-carefully)
- [5. plat (agent + platform service)](#5-plat-agent--platform-service)
  - [What it does](#what-it-does)
  - [Degradation modes](#degradation-modes)
- [6. Cross-system messaging](#6-cross-system-messaging)
- [7. Compatible alternatives](#7-compatible-alternatives)
- [8. Open questions](#8-open-questions)
- [9. Decision log](#9-decision-log)
  - [Docks are compositions of addressed components; the station is the only cross-dock actor (2026-06-12)](#docks-are-compositions-of-addressed-components-the-station-is-the-only-cross-dock-actor-2026-06-12)
  - [One WebSocket server: station drives the body, firmware goes client-only (2026-06-12)](#one-websocket-server-station-drives-the-body-firmware-goes-client-only-2026-06-12)
  - [Server-side brain experiment (2026-06-11)](#server-side-brain-experiment-2026-06-11)
  - [orbit-station split (2026-06-02)](#orbit-station-split-2026-06-02)
  - [orbit terminology (2026-05-18)](#orbit-terminology-2026-05-18)
  - [Multi-node architecture (dock + rover + plat)](#multi-node-architecture-dock--rover--plat)
  - [N-node native, 1-dock first](#n-node-native-1-dock-first)
  - [WebRTC for docks, ROS2 for rover, plat bridges](#webrtc-for-docks-ros2-for-rover-plat-bridges)
  - [Rover stack: linorobot2 (don't roll our own)](#rover-stack-linorobot2-dont-roll-our-own)
  - [Wheels, not legs (for rover)](#wheels-not-legs-for-rover)
  - [Wall-wart power now, battery retrofit later (rover)](#wall-wart-power-now-battery-retrofit-later-rover)
  - [Encoders day one (rover)](#encoders-day-one-rover)
  - [IMU: MPU9250 (not BNO055)](#imu-mpu9250-not-bno055)
  - [Nav2 + slam_toolbox for navigation](#nav2--slam_toolbox-for-navigation)
  - [LIDAR + depth camera (LD06 + OAK-D Lite)](#lidar--depth-camera-ld06--oak-d-lite)
  - [Rover's mic downgraded to cheap USB](#rovers-mic-downgraded-to-cheap-usb)
  - [Dock = Android phone (Pixel-class), not Pi+mic boards](#dock--android-phone-pixel-class-not-pimic-boards)
  - [Dock can have local active behavior (not strictly "dumb edge")](#dock-can-have-local-active-behavior-not-strictly-dumb-edge)
  - [Dock body is optional and additive](#dock-body-is-optional-and-additive)
  - [Always-on, VAD-based segmentation (no wake word)](#always-on-vad-based-segmentation-no-wake-word)
  - [Privacy posture: local-only by default](#privacy-posture-local-only-by-default)
  - [Form factor (rover): floor robot ~25–35 cm](#form-factor-rover-floor-robot-2535-cm)
  - [Form factor (dock): desk-resident, optionally expressive](#form-factor-dock-desk-resident-optionally-expressive)
  - [Self-update (OTA) rides orbit-station, no app store](#self-update-ota-rides-orbit-station-no-app-store)
- [10. Where features live — the decision frame](#10-where-features-live--the-decision-frame)
<!-- /TOC -->
