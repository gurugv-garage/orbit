...
## Contents
- [1. The processes — what runs, and why](#1-the-processes--what-runs-and-why)
- [2. Start everything (in order)](#2-start-everything-in-order)
  - [2a. The two MLX sidecars (Apple Silicon)](#2a-the-two-mlx-sidecars-apple-silicon)
...
- [6. What remains (not yet built)](#6-what-remains-not-yet-built)
- [7. Shutdown / housekeeping](#7-shutdown--housekeeping)
<!-- /TOC -->
