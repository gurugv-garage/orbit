...
- [2. Add bot token scopes](#2-add-bot-token-scopes)
- [3. Install & copy the token](#3-install--copy-the-token)
- [4. Configure orbit-station](#4-configure-orbit-station)
- [5. Invite the bot to the channel](#5-invite-the-bot-to-the-channel)
- [6. Restart & try it](#6-restart--try-it)
- [Verify the setup (live)](#verify-the-setup-live)
- [Inbound — the dock *hearing* Slack (Socket Mode)](#inbound--the-dock-hearing-slack-socket-mode)
  - [Enable it](#enable-it)
