...
## Contents
- [0. pi's documented extension surface (the menu)](#0-pis-documented-extension-surface-the-menu)
- [1. The three exposable capabilities (pi-native), each grant-gated](#1-the-three-exposable-capabilities-pi-native-each-grant-gated)
  - [1a. Skills (pi **Skills** — on-demand `SKILL.md` packs)](#1a-skills-pi-skills--on-demand-skillmd-packs)
  - [1b. Tools & lifecycle (pi **Extensions** — `registerTool` / `on(event)`)](#1b-tools--lifecycle-pi-extensions--registertool--onevent)
  - [1c. Models & providers (pi **Custom Models** / **Custom Providers**)](#1c-models--providers-pi-custom-models--custom-providers)
- [2. Design principles (unchanged from the grants model)](#2-design-principles-unchanged-from-the-grants-model)
- [3. Wiring summary (the seams already exist)](#3-wiring-summary-the-seams-already-exist)
- [4. TODO](#4-todo)
