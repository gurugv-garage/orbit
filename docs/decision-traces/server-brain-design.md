...
## Contents
- [0. Decisions already made](#0-decisions-already-made)
- [1. Why](#1-why)
- [2. Architecture](#2-architecture)
- [3. Wire protocol — topic `agent`](#3-wire-protocol--topic-agent)
  - [Semantics](#semantics)
- [4. Streaming-first pipeline](#4-streaming-first-pipeline)
- [5. Sessions & profiles (pi-side management)](#5-sessions--profiles-pi-side-management)
- [6. STT/TTS placement](#6-stttts-placement)
- [7. Perf analysis — measured, not guessed](#7-perf-analysis--measured-not-guessed)
  - [7.1 Station-mode re-measurement (2026-06-12, post-cutover)](#71-station-mode-re-measurement-2026-06-12-post-cutover)
- [8. Risks & cons (honest list)](#8-risks--cons-honest-list)
- [9. Pros](#9-pros)
