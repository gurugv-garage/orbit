...
## Contents
- [1. The thesis (user, 2026-07-06)](#1-the-thesis-user-2026-07-06)
- [2. What exists today (the audit)](#2-what-exists-today-the-audit)
- [3. The curator: who actually uses it, and the verdict](#3-the-curator-who-actually-uses-it-and-the-verdict)
- [4. The model — one pipeline, three horizons](#4-the-model--one-pipeline-three-horizons)
- [5. What changes / what deliberately does not](#5-what-changes--what-deliberately-does-not)
