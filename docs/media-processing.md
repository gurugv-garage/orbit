...
## Contents
- [0. Where the tap sits](#0-where-the-tap-sits)
- [1. Same box — process inside orbit-station](#1-same-box--process-inside-orbit-station)
- [2. Separate box — forward to a sidecar](#2-separate-box--forward-to-a-sidecar)
  - [Wire framing](#wire-framing)
  - [Decoding in the sidecar](#decoding-in-the-sidecar)
- [3. Choosing](#3-choosing)
