...
## Contents
- [As-built design (outbound) & decisions](#as-built-design-outbound--decisions)
- [Pending / not built](#pending--not-built)
- [1. Create a Meta app](#1-create-a-meta-app)
- [2. Get credentials](#2-get-credentials)
- [3. Add allowed recipients](#3-add-allowed-recipients)
- [4. Configure orbit-station](#4-configure-orbit-station)
- [5. Two-way — the dock *hearing* WhatsApp (webhook)](#5-two-way--the-dock-hearing-whatsapp-webhook)
- [6. Restart & try it](#6-restart--try-it)
  - [Branding (name + logo) — needs a registered number](#branding-name--logo--needs-a-registered-number)
- [How it works (under the hood)](#how-it-works-under-the-hood)
- [Troubleshooting](#troubleshooting)
- [Footnote: unofficial libraries (not recommended)](#footnote-unofficial-libraries-not-recommended)
<!-- /TOC -->
