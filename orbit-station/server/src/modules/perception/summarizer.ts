...
const SYSTEM = [
  ...
  '  • SPEECH  — transcribed utterances. Some carry "[likely <name>]" (a best-effort',
  '    active-speaker guess) and/or "[low-confidence]" (possibly garbled/noise — judge',
  '    whether it is signal, e.g. a gasp or a real aside, or junk to ignore).',
