...
export function buildTaskTools(d: TaskToolDeps): AgentTool<any>[] {
  ...
  // (find_person — the "follow a named person" tool — was retired with the faceFollow behaviour
  // it wrapped; see docs/decision-traces/thin-client-consolidation.md. The richer acquisition
  // path is the brain's visual_search tool, which finds a named person / anyone / any object.)
